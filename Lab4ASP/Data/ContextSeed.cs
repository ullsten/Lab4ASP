    ...
    public static class ContextSeed
    {
        ...
        public static async Task SeedSuperAdminAsync(UserManager<ApplicationUser> userManager, RoleManager<IdentityRole> roleManager )
        {
            ...
            if (userManager.Users.All(u => u.Id != defaultUser.Id))
            {
                ...
                if (user == null)
                {
                    ...
                    await userManager.CreateAsync(adminUser, "Gokkster1982!");
        ...
        public static void Initialize(ApplicationDbContext context)
        {
            ...
            if (!context.Addresses.Any())
            {
                ...
                {
                    new Address { Street = "Byskillnadsvägen 14", City = "Köpmanholmen", PostalCode = "89340", FK_UserId = "d8a16d20-210e-4e84-8ef3-4c0fa037a173" },
                    new Address { Street = "456 Elm Avenue", City = "Los Angeles", PostalCode = "90001", FK_UserId = "d8a16d20-210e-4e84-8ef3-4c0fa037a173"},
                    new Address { Street = "789 Oak Drive", City = "Chicago", PostalCode = "60601", FK_UserId = "d8a16d20-210e-4e84-8ef3-4c0fa037a173" },
                    new Address { Street = "321 Pine Street", City = "San Francisco", PostalCode = "94101", FK_UserId = "d8a16d20-210e-4e84-8ef3-4c0fa037a173" },
                    new Address { Street = "987 Maple Lane", City = "Seattle", PostalCode = "98101", FK_UserId = "d8a16d20-210e-4e84-8ef3-4c0fa037a173" },
                    new Address { Street = "654 Cedar Road", City = "Miami", PostalCode = "33101", FK_UserId = "d8a16d20-210e-4e84-8ef3-4c0fa037a173" },
                };

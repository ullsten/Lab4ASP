    ...
    public static class ContextSeed
    {
        ...
        public static async Task SeedSuperAdminAsync(UserManager<ApplicationUser> userManager, RoleManager<IdentityRole> roleManager )
        {
            ...
            if (userManager.Users.All(u => u.Id != defaultUser.Id))
            {
                ...
                if (user == null)
                {
                    await userManager.CreateAsync(defaultUser, "Gokkster1982!");
                    await userManager.AddToRoleAsync(defaultUser, Enums.Roles.SuperAdmin.ToString());
                    await userManager.CreateAsync(basicUser, "Gokkster1982!");
        ...
        public static void Initialize(ApplicationDbContext context)
        {
            ...
            if (!context.BookTypes.Any())
            {
                var bookTypes = new BookType[]
                {
                    ...
                    new BookType {BookTypeName = "Southern Gothic"},
                    new BookType {BookTypeName = "Tragedy"},
                    new BookType {BookTypeName = "High fantasy"},
                    new BookType {BookTypeName = "Realistic fiction"},
                    new BookType {BookTypeName = "Dystopia"},
                    new BookType {BookTypeName = "Adventure fiction"},
                    new BookType {BookTypeName = "Comic science fiction"},
                    new BookType {BookTypeName = "historical fiction"}
                };
            ...
            if (!context.Addresses.Any())
            {
                ...
                {
                    new Address { Street = "Byskillnadsvägen 14", City = "Köpmanholmen", PostalCode = "89340"},
                    new Address { Street = "456 Elm Avenue", City = "Los Angeles", PostalCode = "90001",},
                    new Address { Street = "789 Oak Drive", City = "Chicago", PostalCode = "60601"},
                    new Address { Street = "321 Pine Street", City = "San Francisco", PostalCode = "94101" },
                    new Address { Street = "987 Maple Lane", City = "Seattle", PostalCode = "98101" },
                    new Address { Street = "654 Cedar Road", City = "Miami", PostalCode = "33101" },
                };          
            ...
            if (!context.Books.Any())
            {
                var books = new Book[]
                {
                    new Book { BookTitle = "The Great Gatsby", BookDescription = "A classic novel about the Roaring Twenties", PublishedYear = 1925, Quantity = 2, FK_BookTypeId = 10 },
                    new Book { BookTitle = "To Kill a Mockingbird", BookDescription = "A story about racism and injustice in the American South", PublishedYear = 1960, Quantity = 2, FK_BookTypeId = 9 },
                    ...
                    new Book { BookTitle = "1984", BookDescription = "A dystopian novel about a totalitarian government", PublishedYear = 1949, Quantity = 2, FK_BookTypeId = 14 },
                    new Book { BookTitle = "The Catcher in the Rye", BookDescription = "A coming-of-age story about a teenage boy in New York City", PublishedYear = 1951, Quantity = 2, FK_BookTypeId = 13 },
                    new Book { BookTitle = "Moby-Dick", BookDescription = "A novel about Captain Ahab's obsession with a white whale", PublishedYear = 1851, Quantity = 2, FK_BookTypeId = 15 },
                    new Book { BookTitle = "The Hitchhiker's Guide to the Galaxy", BookDescription = "A humorous science fiction book about the end of the world", PublishedYear = 1979, Quantity = 2, FK_BookTypeId = 16 },
                    new Book { BookTitle = "The Hunger Games", BookDescription = "A dystopian novel about a teenage girl who must compete in a fight to the death", PublishedYear = 2008, Quantity = 2, FK_BookTypeId = 15 },
                    new Book { BookTitle = "Gone with the Wind", BookDescription = "A historical romance set in the American South during the Civil War", PublishedYear = 1936, Quantity = 2, FK_BookTypeId = 16 }
                };
